...
public class Bigarm {
		...
		for (String word : allOriginals) {
			...
			for (int i = 0; i < word.length() - 1; i++) {
				...
				if (!savedSub.contains(subString)) {
					...
					// save into db
					boolean bool = DBConnection.insertIntoBigramIndex(subString, allWordsToSave);
					if (bool) {
	...
	public List<String> cuttingQuery(String query) {
	...
	private ArrayList<String> calculateJaccardCoefficient(String word, String allWords) {
